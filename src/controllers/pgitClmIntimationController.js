const pgitClmIntimationService = require('../services/pgitClmIntimationService');
...
exports.getAll = async (req, res, next) => {
  try {
    ...
    const result = await pgitClmIntimationService.getAll(filters, queryOptions);
...
exports.create = async (req, res, next) => {
  try {
    const result = await pgitClmIntimationService.create(req.body);
...
exports.update = async (req, res, next) => {
  try {
    const result = await pgitClmIntimationService.update(req.params.id, req.body);
...
exports.deleteItem = async (req, res, next) => {
  try {
    const result = await pgitClmIntimationService.deleteItem(req.params.id);
