const pgitClmApplPolicyService = require('../services/pgitClmApplPolicyService');
...
exports.getAll = async (req, res, next) => {
  try {
    ...
    const result = await pgitClmApplPolicyService.getAll(filters, queryOptions);
...
exports.update = async (req, res, next) => {
  try {
    const result = await pgitClmApplPolicyService.update(req.params.id, req.body);
...
exports.deleteItem = async (req, res, next) => {
  try {
    const result = await pgitClmApplPolicyService.deleteItem(req.params.id);
